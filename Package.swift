...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/KittyMac/Flynn.git", .upToNextMajor(from: "0.1.3"))
    ],
    targets: [
    // Targets are the basic building blocks of a package. A target can define a module or a test suite.        
        .target(
            name: "colt",
            dependencies: [.product(name: "ArgumentParser", package: "swift-argument-parser"), "Progress", "INI", "Flynn"]),
        .testTarget(
            name: "ColtTests",
            dependencies: ["colt"])
    ]
